...
function register_widget_areas() {
  ...
  register_sidebar( array(
    ...
    'before_widget' => '<section class="footer-sidebar footer-sidebar1">',
  ...
  register_sidebar( array(
    ...
    'id'            => 'footer_area_two',
    'description'   => 'This widget area discription',
    'before_widget' => '<section class="footer-sidebar footer-sidebar2">',
    'after_widget'  => '</section>',
    'before_title'  => '<h4>',
    'after_title'   => '</h4>',
  ));
  ...
  register_sidebar( array(
    ...
    'description'   => 'This widget area discription',
    'before_widget' => '<section class="footer-sidebar footer-sidebar3">',
    'after_widget'  => '</section>',
    'before_title'  => '<h4>',
    'after_title'   => '</h4>',
  ));
  ...
  register_sidebar( array(
    ...
    'id'            => 'footer_area_four',
    'description'   => 'This widget area discription',
    'before_widget' => '<section class="footer-area footer-sidebar4">',
    'after_widget'  => '</section>',
    'before_title'  => '<h4>',
    'after_title'   => '</h4>',
  ));
